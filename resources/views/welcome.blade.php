    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
            <div class="container px-4 px-lg-5">
                <a class="navbar-brand" href="#page-top">InvestChamp</a>
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item"><a class="nav-link" href="#about">Investors</a></li>
            ...
            <div class="container px-4 px-lg-5 d-flex h-100 align-items-center justify-content-center">
                <div class="d-flex justify-content-center">
                    <div class="text-center">
                        <h1 class="mx-auto my-0 text-uppercase">Who are we?</h1>
                        <h2 class="text-white-50 mx-auto mt-2 mb-5">InvestChamp is a dynamic investment bank founded in 2010, specializing in providing innovative financial solutions to clients worldwide. With a strong focus on investment advisory, wealth management, and corporate finance, InvestChamp has established itself as a trusted partner for individuals seeking growth and financial stability. Its mission is to empower clients with expert insights, tailored strategies, and cutting-edge tools to navigate the complexities of the global financial market.</h2>
                    </div>
                </div>
            </div>
        </header>
        ...
        <section class="about-section text-center" id="about">
            <div class="container px-4 px-lg-5">
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-lg-8">
                        <h1 class="text-white mb-4">Become an Investor</h1>
                        <h2 class="text-white mb-4">Qualifications for Becoming an Investor:</h2>
